...
def merge_phase_1_back():
    main_file_path = r"c:\Users\Roy\Desktop\AI\Slow-Build-Check-In\data\phase_1\questions.json"
    ...
    try:
        ...
        print(f"Successfully updated {updates_count} questions in Phase 1 questions.json")
    except Exception as e:
